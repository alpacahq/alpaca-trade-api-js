...
function Alpaca(config = {}) {
  ...
  this.websockets = new websockets.AlpacaStreamClient({
    url: this.configuration.baseUrl,
    apiKey: this.configuration.keyId,
    secretKey: this.configuration.secretKey
  })
  this.websockets.STATE = websockets.STATE
  this.websockets.EVENT = websockets.EVENT
  this.websockets.ERROR = websockets.ERROR
}
