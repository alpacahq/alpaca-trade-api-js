class AlpacaCORS {
  ...
  getAccount() {
    return this.httpRequest(
      "GET",
      this.argsFormatter("account", undefined, undefined)
    )
      .then((resp) => {
        return resp.json();
      })
  ...
  createOrder(body) {
    return this.httpRequest(
      "POST",
      this.argsFormatter("orders", undefined, undefined),
      JSON.stringify(body)
    )
      .then((resp) => {
        return resp.json();
  ...
  getOrders(query = undefined) {
    return this.httpRequest(
      "GET",
      this.argsFormatter("orders", undefined, query)
    )
      .then((resp) => {
        return resp.json();
      })
  ...
  getOrder(path) {
    return this.httpRequest(
      "GET",
      this.argsFormatter("orders", [path], undefined)
    )
      .then((resp) => {
        return resp.json();
      })
  ...
  getOrderByClientId(query) {
    return this.httpRequest(
      "GET",
      this.argsFormatter("orders:by_client_order_id", undefined, query)
    )
      .then((resp) => {
        return resp.json();
      })
  ...
  getPosition(path) {
    return this.httpRequest(
      "GET",
      this.argsFormatter("positions", [path], undefined)
    )
      .then((resp) => {
        return resp.json();
      })
  ...
  getPositions() {
    return this.httpRequest(
      "GET",
      this.argsFormatter("positions", undefined, undefined)
    )
      .then((resp) => {
        return resp.json();
      })
  ...
  getAssets(query = undefined) {
    return this.httpRequest(
      "GET",
      this.argsFormatter("assets", undefined, query)
    )
      .then((resp) => {
        return resp.json();
      })
  ...
  getAsset(path) {
    return this.httpRequest(
      "GET",
      this.argsFormatter("assets", [path], undefined)
    )
      .then((resp) => {
        return resp.json();
      })
  ...
  getCalendar(query = undefined) {
    return this.httpRequest(
      "GET",
      this.argsFormatter("calendar", undefined, query)
    )
      .then((resp) => {
        return resp.json();
      })
  ...
  getClock() {
    return this.httpRequest(
      "GET",
      this.argsFormatter("clock", undefined, undefined)
    )
      .then((resp) => {
        return resp.json();
      })
  ...
  getBars(path, query1, query2 = undefined) {
    ...
    return this.dataHttpRequest(
      ...
      this.argsFormatter(
        "bars",
        [path],
        Object.assign({ symbols: query }, query2)
      )
    )
      .then((resp) => {
        return resp.json();
