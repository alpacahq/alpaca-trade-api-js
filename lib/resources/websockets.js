...
import polygon from "./polygonWebsocket";
...
class AlpacaStreamClient extends events.EventEmitter {
  constructor(opts = {}) {
    ...
    this.polygon = new polygon.PolygonWebsocket(
      this.session.apiKey,
      this.session
    );
  }
...
export default { AlpacaStreamClient, STATE, EVENT, ERROR };
