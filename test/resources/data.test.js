...
describe('data API', function () {
  ...
  describe('get aggregates', function () {
    it('fetches the aggregates', function () {
      return expect(alpaca.getAggregates('AAPL', 'day', '2020-01-01', '2020-01-05')).to.eventually.have.property('queryCount')
    })
  })

  describe('get last trade', function () {
    it('fetches last trade', function () {
      return expect(alpaca.lastTrade('AAPL')).to.eventually.have.property('last')
    })
  })

  describe('get last quote', function () {
    it('fetches last quote', function () {
      return expect(alpaca.lastQuote('AAPL')).to.eventually.have.property('last')
    })
  })
})
