...
import joi from "joi";
import { apiMethod, assertSchema, apiError } from "./assertions";
...
export default function createPolygonMock() {
  ...
  v1.get(
    "/marketstatus/now",
    apiMethod(() => marketStatusEntity)
  );
  v1.get(
    "/marketstatus/upcoming",
    apiMethod(() => [holidayEntity])
  );
  v1.get(
    "/meta/exchanges",
    apiMethod(() => [exchangeEntity])
  );
  v1.get(
    "/meta/symbol-types",
    apiMethod(() => symbolTypeMapEntity)
  );
...
const symbolNewsEntity = {
  ...
  url:
    "https://seekingalpha.com/news/3328826-goldman-talks-finance-iphones-wsj",
  source: "SeekingAlpha",
  summary:
    "Continuing its push into more traditional areas of consumer finance, Goldman Sachs (NYSE:GS) is reportedly in talks with Apple (NASDAQ:AAPL) to finance iPhone purchases.Buyers theoretically would be a...",
  image:
    "https://static.seekingalpha.com/assets/og_image_410-b8960ce31ec84f7f12dba11a09fc1849b69b234e0f5f39d7c62f46f8692e58a5.png",
